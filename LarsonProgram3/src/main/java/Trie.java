...
public class Trie implements TrieADT{
     ...
     * reads a file and populates an arraylist called dictionary with words
    ...
    public void createDictionary() throws FileNotFoundException {
        ...
        // reading from filename and catching any file not found exceptions
        ...
        for(String word : dictionary) {
            ...
            for(char letter : word.toCharArray()) {
                if(!current.contains(letter)) {
                    TrieNode next = new TrieNode(letter);
    ...
    public ArrayList<String> words(TrieNode node, String prefix, ArrayList<String> output) {
        ...
        for(TrieNode tempNode : node.getNext()) {
            String temp = prefix + tempNode.getLetter();
            words(tempNode, temp, output);
        }
        return output;
    }
    ...
    public ArrayList<String> prefixWords(String prefix) {
        ...
        for(char letter : prefix.toCharArray()) {
            TrieNode temp = current.get(letter);
            // error check
            if(temp == null) {
        ...
        // recursively call the prefixWords method
    ...
    public ArrayList<String> prefixWords(TrieNode node, String prefix, String suffix, ArrayList<String> output) {
        ...
        for(TrieNode tempNode : node.getNext()) {
            String temp = suffix + tempNode.getLetter();
            prefixWords(tempNode, prefix, temp, output);
        }
        return output;
    }
